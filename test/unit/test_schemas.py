...
def test_context_configuration_refresh_rate(input_rate: str):
...
def test_context_configuration_refresh_cron(input_cron_expression, expect_success):
    if expect_success:
        context_configuration = ContextConfiguration(
...
def test_context_configuration_sets_default():
