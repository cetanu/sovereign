...
class TestEncryptionWorkflow:
    ...
    def test_using_the_key_to_encrypt_data(
        self, testclient: TestClient, random_sovereign_key
    ):
        response = testclient.post(
            "/crypto/encrypt", json={"data": "hello", "key": random_sovereign_key}
        )
    ...
    def test_using_the_key_to_decrypt_data(
        ...
        response = testclient.post(
            "/crypto/decrypt",
            json={"data": encrypted_data, "key": random_sovereign_key},
        )
